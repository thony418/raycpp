...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR lpCmdLine, int nCmdShow) {
	...
	Scene scene = Scene();
	scene.getLights()->push_back(new Light(Vec3(-10.0f, 0.0f, 0.0f), 1.0f, .5f, .5f));
	...
	scene.getSceneObjects()->push_back(new Sphere(Vec3(1.0f, 1.0f, 7.0f), 2.0f, Material(0.2f, 1.0f, 1.0f, 150.0f, Color(0, 0, 0))));
